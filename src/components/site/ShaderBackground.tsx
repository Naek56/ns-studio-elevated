// ShaderBackground — 21st.dev Shader Builder ("Mesh drift"), recoloré en BLEU.
// Un seul canvas WebGL qui remplit son parent. Utilisé comme fond du site
// agence : <div className="fixed inset-0 -z-10"><ShaderBackground className="absolute inset-0" /></div>
...
const UNIFORMS = {
  // palette BLEUE (marine → bleu → ciel → pâle) au lieu du vert d'origine
  colors: [[0.024,0.071,0.173],[0.086,0.408,0.749],[0.369,0.690,0.933],[0.878,0.941,1.0],[0.878,0.941,1.0],[0.878,0.941,1.0],[0.878,0.941,1.0],[0.878,0.941,1.0]] as [number, number, number][],
  colorCount: 4,
  scale: 1.160,
  intensity: 0.340,
  paramA: 0.500,
